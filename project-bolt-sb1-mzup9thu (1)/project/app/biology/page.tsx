...
import { BookOpen, ArrowRight, Users, Microscope, Dna, Leaf, Recycle, CheckCircle, Clock, Play, Brain, Zap } from 'lucide-react';
                      ...
                      >
                        <Card className="h-full hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 cursor-pointer border-2 hover:border-blue-300">
                          <CardContent className="p-4">
                            ...
                            <div className={`inline-flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium mb-3 ${selectedType?.bgColor} ${selectedType?.color}`}>
                              {selectedType?.icon}
                            ...
                            <div className="flex items-center justify-between text-sm text-gray-500">
                              ...
                              <div className="flex items-center space-x-2">
                                <span className="text-blue-600 font-medium group-hover:text-blue-700">
                                  {isCompleted ? `${getActionText()} Again` : getActionText()}
                                </span>
